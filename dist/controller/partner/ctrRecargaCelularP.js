...
function efetuarRecargaP(res, obj) {
        ...
        sql.connect(helper_1.default.configSql, function (err) {
            ...
            sql.query(strSql, function (err, results) {
                ...
                return axios(config)
                    ...
                    inserirDadosRecargaP(res, obj).then(() => helper_1.default.sendResponse(res, 201, 'Sua recarga foi efetuada com sucesso! Em breve você receberá uma mensagem de confirmação da operadora.'));
                })
...
function inserirDadosRecargaP(res, obj) {
    return __awaiter(this, void 0, void 0, function* () {
        var valor = obj.valor;
        var conta = obj.conta;
...
exports.default = new CtrComprarGiftCardP();
