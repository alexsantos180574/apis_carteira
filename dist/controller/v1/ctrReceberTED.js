...
function inserirDadosTED(res, obj, arr) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        sql.connect(helper_1.default.configSql, function (err) {
            ...
            request.query(strSql, function (err, data) {
                if (err) {
                    console.log(err);
                    helper_1.default.sendErro(res, 401, 'Falha ao receber o TED!');
                }
                else {
...
function retornarDadosTED(res, obj) {
    return __awaiter(this, void 0, void 0, function* () {
        var codigo_fastcash;
...
exports.default = new CtrReceberTED();
