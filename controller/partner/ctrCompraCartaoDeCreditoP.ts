...
async function inserirCompraP(res, obj) {
    var nome;
    var email;
    var celular;
    var tratarCampos = '';
...
async function inserirCartaoP(obj) {
...
async function emitirCompraP(res, obj) {
    var nome;
    var email;
    var celular;
...
export default new CtrCompraCartaoDeCreditoP();