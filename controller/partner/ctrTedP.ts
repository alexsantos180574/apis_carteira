...
async function inserirDadosTEDP(res, obj, nossoNumero) { 
...
async function emitirTEDP(res, obj) {
    var nome;
    var email;
    var celular;
        ...
        sql.query(strSql, function (err, results) {
            ...
            axios(config)
                .then(function (response) {
                    ...
                    inserirDadosTEDP(res, obj, tid)
                        .then(msg => {
                        ///Service.create(obj);
                        Helper.sendSaldo(res, 201, 'TED efetuado com sucesso!');
                    })
