...
async function inserirDadosDeposito(res, obj, arr) {
    ...
    sql.connect(Helper.configSql, function(err) {
        ...
        request.query(strSql, function (err, data) {
            if (err) {
                console.log(err);
                Helper.sendErro(res, 401, 'Falha ao receber o Depósito!');
            }else{
...
async function retornarDadosDeposito(res, obj) {
    var codigo_fastcash;
...
export default new CtrReceberDeposito();