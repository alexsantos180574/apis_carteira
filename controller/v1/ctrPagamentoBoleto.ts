...
async function inserirDadosPagamento(res, obj, nossoNumero) {
...
async function emitirPagamento(res, obj) {
    var nome;
    var email;
    var celular;
    var data_atual;
        ...
        sql.query(strSql, function (err, results) {
            ...
            return axios(config)
                .then(function (response) {
                    ...
                    inserirDadosPagamento(res, obj, tid);
            })
            .catch(function (error) {
                console.log(error);
                Helper.sendErro(res, 500, 'Ocorreu um problema interna, por favor, tente mais tarde!');
...
export default new ctrPagamentoBoleto();