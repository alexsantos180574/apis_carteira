...
async function efetuarRecarga(res, obj) {
    var nome = '';
    var email;
    var celular;
        ...
        sql.query(strSql, function (err, results) {
            ...
            return axios(config)
                   .then(function (response) {
                        ...
                        inserirDadosRecarga(res, obj).then(() => Helper.sendResponse(res, 201, 'Sua recarga foi efetuada com sucesso! Em breve você receberá uma mensagem de confirmação da operadora.'));
                    })
...
async function inserirDadosRecarga(res, obj){
    var valor = obj.valor;
    var conta = obj.conta;
